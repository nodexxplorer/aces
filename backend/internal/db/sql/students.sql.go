...
const updateStudentOnboarding = `-- name: UpdateStudentOnboarding :one
UPDATE students
SET
    admission_mode = $2,
    year_admitted = $3,
...
func (q *Queries) UpdateStudentOnboarding(ctx context.Context, arg UpdateStudentOnboardingParams) (Student, error) {
	row := q.db.QueryRow(ctx, updateStudentOnboarding,
		arg.UserID,
		arg.AdmissionMode,
		arg.YearAdmitted,
