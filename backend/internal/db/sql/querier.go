...
type Querier interface {
	...
	ListDMConversations(ctx context.Context, userID uuid.UUID) ([]DMConversationRow, error)
	ListGroupConversations(ctx context.Context, userID uuid.UUID) ([]GroupConversationRow, error)
	GetGroupMemberRole(ctx context.Context, groupID, userID uuid.UUID) (string, error)
	EnsureGroupInviteCode(ctx context.Context, groupID uuid.UUID) (string, error)
	GetGroupByInviteCode(ctx context.Context, code string) (GroupByCodeRow, error)
	...
	ListClassNoticesForViewer(ctx context.Context, arg ListClassNoticesForViewerParams) ([]ListClassNoticesForViewerRow, error)
