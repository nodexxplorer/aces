...
import { HelpCircle, MessageSquare, Search, ThumbsUp, ChevronDown, ChevronRight, BookOpen, Plus, Star, Send, FileText, Bug, Lightbulb, Mail, Phone, CreditCard } from 'lucide-react';
